    ...
    <Stack className="filter-main">
      ...
      <Stack className="find-your-home" mb={"30px"}>
        ...
        <Stack className="button-group">
          <Button sx={{ borderRadius: "12px 0 0 12px", border: "1px solid #b9b9b9" }}>
            Any
          </Button>
          <Button sx={{ borderRadius: 0, border: "1px solid #b9b9b9" }}>1</Button>
          <Button sx={{ borderRadius: 0, border: "2px solid #181A20" }}>2</Button>
          <Button sx={{ borderRadius: 0, border: "1px solid #b9b9b9" }}>3</Button>
          <Button sx={{ borderRadius: 0, border: "1px solid #b9b9b9" }}>4</Button>
          <Button sx={{ borderRadius: "0 12px 12px 0", border: "1px solid #b9b9b9" }}>
            5+
          </Button>
        </Stack>
      </Stack>
